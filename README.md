...
```text
public/media/save-the-date.mp4
```

Per ora il file non e incluso nel repo. Quando sara pronto, conviene metterlo in `public/media/` se resta un asset statico servito da Vite. Se il video sara pesante o dovra essere protetto, meglio usare storage esterno/CDN con URL firmati dopo il login invito.

Il poster provvisorio punta a:

```text
public/save-the-date-poster.jpg
```
